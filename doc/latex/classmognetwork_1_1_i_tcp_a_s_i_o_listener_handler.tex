...
{\em client} & the connected client \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em client} & the disconnected client \\
\hline
\end{DoxyParams}
...
Called when a client send datas, and the datas are fully readed. 


\begin{DoxyParams}{Parameters}
{\em client} & the client who sended the datas \\
\hline
\end{DoxyParams}
